...
using ExpensesFlows.Domain.Enums;
...
public class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseEnvironment("Test")
            .ConfigureServices(services =>
            {
                ...
                services.AddDbContext<ExpensesFlowsDbContext>(config =>
                {
                ...
                var dbContext = scope.ServiceProvider.GetRequiredService<ExpensesFlowsDbContext>();
    ...
    private void StartDatabase(
        ExpensesFlowsDbContext dbContext,
    ...
    private Expense AddExpenses(ExpensesFlowsDbContext dbContext, User user, long expenseId, long tagId)
    {
