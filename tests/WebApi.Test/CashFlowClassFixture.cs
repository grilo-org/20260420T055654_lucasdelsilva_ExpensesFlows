...
public class ExpensesFlowsClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public ExpensesFlowsClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
